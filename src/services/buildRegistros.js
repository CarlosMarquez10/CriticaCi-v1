...
/**
 * Construye registros enriquecidos a partir de DatosConsulta.json
 * @async
 * @function buildRegistros
 * @returns {Promise<Array>} Array de registros procesados
 */
export async function buildRegistros() {
